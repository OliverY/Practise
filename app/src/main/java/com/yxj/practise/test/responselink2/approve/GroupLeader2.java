 ...
 * Description:
 */
public class GroupLeader2 extends BaseApprove {

    @Override
    protected void handle(Request2 request2) {
        Log.e("yxj", "GroupLeader2::这个我批准了");
    }

    @Override
    protected boolean isHandled(Request2 request2) {
        Log.e("yxj","GroupLeader2 开始处理");
        if(request2.money<10) {
            return true;
        }else{
            Log.e("yxj","GroupLeader2 超过了职权，交给下一个吧");
            return false;
        }
    }
}
